...
const imgAbout = "/muneeb_parammal.png";
const imgPlus = "/plus2.svg";
    ...
    <section className="w-full py-10">
      <div className="w-full max-w-[550px] flex flex-col gap-[10px]  md:px-0">
        ...
        <div className="flex flex-col gap-[10px] md:flex-row">
          ...
          {/* 95% card */}
          <div className="relative flex min-h-[240px] flex-1 flex-col justify-between overflow-hidden rounded-[24px] bg-[#012970] p-6 md:h-[273px] md:rounded-[36px] md:p-[40px]">
            {/* Decorative dot grid */}
            <div className=" right-6 top-6 grid grid-cols-8 gap-[8px] opacity-30 md:right-[40px] md:top-[40px] md:gap-[10px]">
